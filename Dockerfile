...
ARG ARG_LAMBETH_NEXT_PUBLIC_SANITY_SECRET_TOKEN
ARG ARG_LAMBETH_NEXT_PUBLIC_API_KEY
...
ENV NEXT_PUBLIC_SANITY_SECRET_TOKEN $ARG_LAMBETH_NEXT_PUBLIC_SANITY_SECRET_TOKEN
ENV NEXT_PUBLIC_API_KEY $ARG_LAMBETH_NEXT_PUBLIC_API_KEY

# Debug: Print the value of NEXT_PUBLIC_SANITY_PROJECT_ID
RUN echo "NEXT_PUBLIC_SANITY_PROJECT_ID is set to: $NEXT_PUBLIC_SANITY_PROJECT_ID"
RUN echo "NEXT_PUBLIC_SANITY_DATASET is set to: $NEXT_PUBLIC_SANITY_DATASET"
RUN echo "NEXT_PUBLIC_SANITY_DATASET is set to: $ARG_NEXT_PUBLIC_SANITY_DATASET"
