  ...
  return (
    <section className="impact-wrap">
      <div>
        ...
        <p className="govuk-body">
          We’ve outlined some of the ways we think this development would impact
          your community, so that you can give us feedback on what’s important
          for us to consider when we’re deciding what to give planning
          permission for.
        </p>
            ...
            <div className="impact-item-container">
              ...
              <>
                ...
                {data?.housing?.affordableResidentialUnits && (
                  <p className="govuk-body" style={{ marginTop: "-10px" }}>
                    <span className="govuk-!-font-weight-bold">
                      {data?.housing?.affordableResidentialUnits}%
                    </span>{" "}
                    affordable housing
