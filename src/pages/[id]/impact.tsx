                ...
                <div>
                    ...
                    showHealthcare && (
                            <>
                                ...
                                <p className="govuk-body small-margin-top"><span className="govuk-!-font-weight-bold">{healthcareDemand}</span>addicional demand on GPs and hospitals</p>
                ...
                <div>
                    {
                        showOpenSpace && (
                            <>
                                ...
                                <p className="govuk-body large-margin-top" ><span className="govuk-!-font-weight-bold">{openSpaceArea}</span> square metres</p>
                ...
                <div>
                    {
                        showJobs && (
                            <>
                                ...
                                <p className="govuk-body large-margin-top" ><span className="govuk-!-font-weight-bold">{jobs?.min}-{jobs?.max}</span> new roles</p>
                ...
                <div>
                    {
                        showCarbon && (
                            <>
                                ...
                                <p className="govuk-body large-margin-top"><span className="govuk-!-font-weight-bold">{carbonEmissions}%</span> more CO2 emissions</p>
